...
function CardBenefitsList({ benefits, backgroundColor }: Props) {
  return (
    <div className="max-w-[1500px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[15px] justify-items-center">
      {benefits.map((benefit) => (
        <div
          key={benefit.id}
          className={`${backgroundColor} px-5 py-8 rounded-lg w-full max-w-[450px] min-h-[273px]`}
        >
          <Image
