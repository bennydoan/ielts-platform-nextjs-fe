...
function CardComponent({ header, imgSrc, alt, isDeveloping }: Props) {
  return (
    <div className="bg-white rounded-xl px-3 lg:px-6 pt-4 lg:pt-5.5 shadow-[0px_20px_50px_0px_#12112714] w-[440px] h-[200px] sm:w-[300px] md:w-[370px] lg:w-[210px] lg:h-[250px] xl:w-[280px] ">
