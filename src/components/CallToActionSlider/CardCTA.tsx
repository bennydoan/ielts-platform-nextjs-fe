...
const CardCTA: React.FC = () => {
  return (
    <div className="card-cta bg-red-500 p-10 flex justify-center items-center">
      <div className="flex flex-col lg:flex-row justify-between items-center max-w-6xl w-full">
        <div className="relative flex-shrink-0 w-[420px] h-[350px] m-10">
          <Image
            src="/images/CardCTA/cta-ellipse-1.0ac92645.svg"
            alt="CTA Image"
            width={300}
            height={300}
          ...
          />
          <Image
            src="/images/CardCTA/cta-ellipse-2.f597b8f9.svg"
            alt="CTA Image"
            width={150}
            height={150}
            className="absolute top-47 right-68"
          />
          <Image
            src="/images/CardCTA/star-3.a6b54be6.svg"
            alt="Star"
            width={22}
            height={22}
        ...
        <div className="flex flex-col m-10 max-w-[420px]">
          ...
          <p className="text-xl text-gray-100 my-4">
            Học theo đúng định dạng đề thi, luyện tập hiệu quả, chấm điểm tức
            thì và tiết kiệm thời gian, vì chúng tôi hiểu bạn bận rộn.
          </p>
